...
public class Console extends JFrame implements WindowListener, Runnable
{
  ...
  public Console()
  {
    ...
    stopThreads = false; // Will be set to true at closing time. This will stop the
                         // threa.windowOpened(WindowEvent)ds
  ...
  // These methods must implement these inherited abstract methods from
  // WindowListener
  @Override
